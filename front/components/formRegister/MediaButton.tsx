...
import { getLoginFacebook, getLoginGoogle } from '../../services/auth-calls';

const MediaButton = ({ social }: MDProps) => {
  return (
    <div
      className="w-[295px] h-[35px] border-[2px] border-primary rounded-[8px] cursor-pointer flex flex-row items-center justify-start px-2"
