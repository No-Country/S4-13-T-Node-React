...
const FormUpload = () => {
  const validateLoginSchema = Yup.object({
    title: Yup.string().min(2, '').required('Campo requerido'),
    meme_url: Yup.string().min(10, 'La url debe tener al menos 10 caracteres').required('Campo requerido'),
        ...
        return (
          <Form className="flex flex-col gap-y-4">
            ...
            <div className="w-full flex flex-col justify-center items-center">
              ...
              <button className="flex justify-center items-center w-[110px] border-primary border-2 rounded py-[8px] active:border-secondary">
            ...
            <div className="flex justify-end my-2">
              <button
                ...
                className={`font-roboto font-bold text-primary text-base leading-[19px] border-2 border-primary rounded-lg py-2 px-4 ${
                  values.meme_url === '' && 'border-accent text-accent'
                } ${values.meme_url !== '' && 'active:text-secondary active:border-secondary'}`}
                disabled={values.meme_url === ''}
              >
                Subir a Memex
              </button>
            </div>
