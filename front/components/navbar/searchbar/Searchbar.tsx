...
export const Searchbar = () => {
  ...
  return (
    <form
      ...
      className="absolute right-12 top-0 w-auto mx-auto lg:top-[54px] lg:right-[70px] lg:peer-focus:top-16"
    >
      <input
        onChange={handleInput}
        name="search"
        className="top-[4px] lg:top-[10px] font-roboto focus:bg-white placeholder:text-accent peer cursor-pointer relative z-10 h-12 w-12 rounded-[4px] border border-transparent bg-transparent pl-12 outline-none focus:w-40 focus:cursor-text focus:border-secondary focus:pl-4 focus:pr-4 focus:mr-4 ease-linear duration-500"
        placeholder="Buscar"
      />
      <div className="flex justify-center items-center absolute inset-y-0 h-[52px] w-12 border-r border-transparent stroke-gray-500 px-3.5 peer-focus:stroke-primary lg:w-[70px] lg:h-16 lg:px-3.5 lg:border-primary lg:border-2 lg:rounded-b-3xl lg:peer-focus:border-transparent">
        {size.width >= 1440 ? (
